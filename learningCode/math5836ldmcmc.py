...
class MCMC:
    ...
    def sampler(self, w_limit, tau_limit):
        ...
        DEBUG_PROB_STORE = np.zeros((samples-1,7))
        ...
        for i in range(samples - 1):
            ...
            DEBUG_PROB_STORE[i,0] = prior_prop
            DEBUG_PROB_STORE[i,1] = prior_current
            DEBUG_PROB_STORE[i,2] = first
            DEBUG_PROB_STORE[i,3] = second
            DEBUG_PROB_STORE[i,4] = likelihood_proposal
            DEBUG_PROB_STORE[i,5] = likelihood
            DEBUG_PROB_STORE[i,6] = diff_likelihood+diff_prior+ diff_prop
