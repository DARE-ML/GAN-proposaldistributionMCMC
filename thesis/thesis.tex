...
\subsection{Application to Large Dataset}

\subsubsection{Stochastic Langevin Dynamics }
...
\item use different acceptance test like the one in Metropolis Hasting GAN
