...
Seita et al 2018 \cite{ijcai2018-753} followed the work of others (not sure whether to cite) and propose to increase the amount of samples inside a current mini-batch if it fails to satisify a certain constraint. It is not tested with langevin gradient (still reading).
